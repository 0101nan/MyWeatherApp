...
public class WeatherPcpnView extends View {
    ...
    private Float mNextHeightY=0f;
    private Float mHeightY=0f;
    private Float mPreHeightY=0f;
    ...
    public WeatherPcpnView(Context context) {
        super(context);
        init();
    }

    public WeatherPcpnView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public WeatherPcpnView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public void draws(Float preHeightY,Float heightY,int itemType,boolean last,Float max,Float min){
        mMaxNum=max;
        mMinNum=min;
    ...
    public void draws(Float preHeightY,Float heightY,Float nextHeighY,int itemType,Float max,Float min) {
        mMaxNum=max;
        mMinNum=min;
        this.mPreHeightY =preHeightY;
        this.mHeightY = heightY;
    ...
    public void draws(Float heightY,Float nextHeighY, int itemType,Float max,Float min) {
        mMaxNum=max;
        mMinNum=min;
        this.mHeightY = heightY;
        this.mNextHeightY = nextHeighY;
    ...
    private void caculateY(Float maxNum,Float minNum) {
    ...
    public void setText(Float heightText){
        this.mHeightText = heightText.toString();
    }
}
